...
class PostOffice {
    static MakeFormBody(jsonObject) {
        let formEntries = [];
    ...
    static async CheckBalance(username) {
        try {
    ...
    static async BuyItem(username, itemPrice) {
        try {
            let result = await makeRequest({
    ...
    static async GivePoints(username, points) {
        try {
            let result = await makeRequest({
    ...
    static async TriggerKeys(keyList) {
        try {
            let result = await makeRequest({
